...
db.serialize(function(){   
    ...
    db.run("CREATE TABLE Teaches(ID NUMBER< Course_id TEXT, Semester TEXT, Year NUMBER)");
    db.run("INSERT INTO Teaches VALUES(10101, 'CS-101, 1, 'Fall', 2009)");
    db.run("INSERT INTO Teaches VALUES(10101, 'CS-315, 1, 'Spring', 20010)");
    ...
    db.run("INSERT INTO Teaches VALUES(76766, 'CS-319, 1, 'Spring', 2010)");
